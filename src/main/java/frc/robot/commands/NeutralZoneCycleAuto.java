...
public class NeutralZoneCycleAuto extends SequentialCommandGroup {
  public NeutralZoneCycleAuto(CANDriveSubsystem driveSubsystem, CANFuelSubsystem fuelSubsystem) {
